  ...
  return (
    <div className="bg-bg-core min-h-screen pt-32 pb-20 px-4 md:px-10 animate-fade-in">
      <div className="max-w-[1400px] mx-auto">
        ...
        {/* Header */}
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-20 pb-8 border-b border-border-subtle relative">
           <div className="relative animate-slide-in-left">
             ...
             <h1 className="font-display font-extrabold text-4xl md:text-6xl lg:text-8xl text-white mt-2 relative z-0">
